...
function startApp() {
  ...
  // Сначала подгружаем сохранённые координаты карточек, иначе мгновенный
  // рендер из кэша ниже расставит карточки по спирали и тут же перезапишет
  // сохранённый layout в localStorage
  loadCanvasPositions();
